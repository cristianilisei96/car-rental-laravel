    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        @if ($models->count())
            ...
            <div class="overflow-x-auto bg-white dark:bg-gray-800 shadow rounded-lg">
                ...
                <div x-data="{ editOpen: false, editId: null, editName: '', editBrandId: null }" class="overflow-x-auto bg-white dark:bg-gray-800 shadow rounded-lg">
                            ...
                            @foreach ($models as $model)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <!-- Edit Button -->
                                        <button
                                            @click="editId={{ $model->id }}; editName='{{ $model->name }}'; editBrandId={{ $model->brand_id }}; editOpen=true;"
                    ...
                    <!-- Edit Modal -->
                    <div x-show="editOpen" class="fixed inset-0 flex items-center justify-center z-50"
                        style="display:none;">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 z-50 w-full max-w-md">
                            ...
                            <form :action="`/admin/cars/models/${editId}`" method="POST">
                                ...
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Model
                                        Name</label>
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-12 text-center">
                ...
                {{-- <button @click="open = true" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md">
