        ...
        <div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        Messages, cancellation reasons and status history will appear here.
                    </p>
                </div>
            ...
            <div class="mt-6 space-y-4">
                <div class="rounded-2xl bg-gray-100 p-4 dark:bg-gray-950">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Rental request created on {{ $rental->created_at->format('d.m.Y H:i') }}.
                    </p>
                </div>

                <div class="rounded-2xl border border-dashed border-gray-300 p-4 dark:border-gray-700">
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Later, this area will support customer questions, admin replies, cancellation reasons and a full
                        rental timeline.
                    </p>
                </div>
            </div>
