                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        @if(Auth::user()->is_admin === 1)
                            ...
                            <x-dropdown-link :href="route('cars.index')" :active="request()->routeIs('cars.*')">
                                Cars
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('brands.index')" :active="request()->routeIs('brands.*')">
                                {{ __('Car Brand') }}
                            </x-dropdown-link>
                            ...
                            <x-dropdown-link :href="route('models.index')">
                                {{ __('Car Model') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('seats.index')">
                                {{ __('Car Seat') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('statuses.index')">
                                {{ __('Car Status') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('transmissions.index')">
                                {{ __('Car Transmission') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('types.index')">
                                {{ __('Car Type') }}
                            </x-dropdown-link>
                            <x-dropdown-link>Rentals</x-dropdown-link>
                        @else 
