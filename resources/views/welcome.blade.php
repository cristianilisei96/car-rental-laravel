...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
            ...
            <div class="space-x-4">
                ...
                @else
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="inline">
                        @csrf
                        <button type="submit" class="bg-white text-black px-4 py-2 rounded-md hover:bg-gray-200">Logout</button>
                    </form>
                @endguest
            </div>
        </div>
    ...
    <section class="relative h-screen bg-cover bg-center"
        ...
        <div class="relative z-10 flex flex-col justify-center items-center h-full text-center text-white px-6">
            ...
            <!-- Search form -->
            <form id="searchForm" class="bg-white text-black rounded-xl shadow-lg p-6 grid md:grid-cols-3 gap-4">
            <input
                id="pickup"
                type="date"
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <img
                    src="https://images.drive.com.au/caradvice/image/private/c_fill,f_auto,g_auto,h_675,q_auto:good,w_1200/87732bc6b74d1ea80827d3c3615bb2d7"
                    class="w-full h-48 object-cover"
                >
            ...
            <!-- Copy card încă de 2 ori -->
            <!-- temporar mock UI până conectăm DB -->
